document.addEventListener("DOMContentLoaded", () => {
  const translations = {
    fr: {
      ...
      "invaders-tools": "Outil : Thonny",
      "invaders-lang": "Langage de programmation : Python",
      "invaders-time": "Temp : 12h",
      ...
      "platformer-tools": "Outil : Unity",
      "platformer-lang": "Langage de programmation : C#",
      "platformer-status": "Temp : 7 jours",
      ...
      "shootemup-tools": "Outil : Unity",
      "shootemup-lang": "Langage de programmation : C#",
      "shootemup-status": "Temp : 4h",
      ...
      "JAM-tools": "Outil : Unity",
      "JAM-lang": "Langage de programmation : C#",
      "JAM-time": "Temp : 3 days",
      "JAM-link": "Page itch: ",
      ...
      "Mars2-tools": "Outil : Unity",
      "Mars2-lang": "Langage de programmation : C#",
      "Mars2-time": "Temp : 1 semaine",
      ...
      "Godomon-goal": "Projet réalisé dans le cadre des projets LABS au sein de la licence informatique du CNAM Enjmin. J'ai dû réaliser un template de jeu éducatif pour l'Éducation nationale afin de permettre aux lycéens et collégiens d'avoir des cours d'introduction à la création de jeux vidéo. Au cours de ce projet, j'ai appris à utiliser Godot ainsi que son langage de programmation, GDScript. Il s'agit de loin du projet le plus professionnel que j'ai eu l'occasion de réaliser jusqu'à présent. Je suis particulièrement fier de cette réalisation, tant pour la qualité du résultat que pour l'expérience acquise.",
      "Godomon-tools": "Outil : Godot",
      "Godomon-lang": "Langage de programmation : GDscript",
      "Godomon-time": "Temp : 2 mois",
      ...
      "village-time": "Temp : 3h",
      "Assets_House": "projet création d'assets d'une maison en 3D",
      "House-goal": "J’ai commencé un projet personnel dans lequel je reproduis ma maison sur Blender, afin de mettre en pratique tout ce que j’ai appris récemment grâce à des tutoriels en ligne. Voici ce que j'ai pu réaliser pour l'instant.",
      "House-tools": "Outil : Blender",
      "House-time": "Temp : 4h",
      "solo": "(Seul)",
      "groupe": "(En groupe)",
      "code" : "Code du jeu :",
    ...
    en: {
      ...
      "Godomon-goal": "Project completed as part of the LABS projects within the Computer Science Bachelor's degree program at CNAM-Enjmin. I was tasked with developing an educational game template for the French Ministry of Education, allowing middle and high school students to take introductory courses in video game development. During this project, I learned how to use Godot and its programming language, GDScript. It is by far the most professional project I have had the opportunity to work on so far. I am particularly proud of this achievement, both for the quality of the final result and for the experience I gained throughout the project.",
      "Godomon-tools": "Tool : Godot",
      "Godomon-lang": "Programming language : GDscript",
      "Godomon-time": "Time : 2 months",
      ...
      "Assets_House": "Project to create 3D house assets",
      "House-goal": "I've started a personal project where I'm recreating my house in Blender, in order to put into practice everything I've recently learned from online tutorials. Here's what I've managed to achieve so far.",
      "House-tools": "Tool : Blender",
      "House-time": "Time : 4h",
      "solo": "(Alone)",
      "groupe": "(In group)",
      "code" : "Game code :",
...
const imagesHouse = [
  "./assets/Images/RenduAssetHouse-general.png",
  "./assets/Images/RenduAssetHouse-meuble1.png",
  "./assets/Images/RenduAssetHouse-meuble2.png",
  "./assets/Images/RenduAssetHouse-lit.png",
  "./assets/Images/RenduAssetHouse-porte.png",
